CREATE DATABASE  IF NOT EXISTS `coleman_cap` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `coleman_cap`;
-- MySQL dump 10.13  Distrib 5.6.17, for Win32 (x86)
--
-- Host: 127.0.0.1    Database: coleman_cap
-- ------------------------------------------------------
...
CREATE TABLE `customer` (
  ...
  `ContactLast` varchar(20) DEFAULT NULL,
  `ContactFirst` varchar(15) DEFAULT NULL,
...
CREATE TABLE `question` (
  ...
  `OptA` varchar(1) DEFAULT NULL,
  `OptB` varchar(1) DEFAULT NULL,
  `OptC` varchar(1) DEFAULT NULL,
  `OptD` varchar(1) DEFAULT NULL,
...
INSERT INTO `user` VALUES (1,1,'Fetick','Mike','mike','mikeo',2147483647,1);
...
INSERT INTO `usertype` VALUES (1,'Admin'),(2,'Analyst');
...
-- Dump completed on 2014-09-13  8:21:48
